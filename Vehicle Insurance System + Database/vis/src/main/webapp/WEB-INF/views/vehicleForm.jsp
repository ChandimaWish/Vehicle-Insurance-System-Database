			  		...
			  		<div class="panel-body">
	  					...
	  					<form:form class="form-horizontal" action="${contextRoot}/saveVehicleData.html" modelAttribute="vehicle">
	  						...
	  						<div class = "form-group">
	  							...
	  							<div class="col-md-6">
      								<form:input type="date" path = "registrationDate" class="form-control" id="regdate" max="<fmt:formatDate value='${now}' pattern='yyyy-MM-dd' />" />
    							</div>
	  						</div>
	  						...
	  						<div class = "form-group">
	  							...
	  							<div class="col-md-6">
									...
									<button type = "button" class = "btn btn-danger"  onclick="resetForm()"><spring:message code="reset"/></button>
