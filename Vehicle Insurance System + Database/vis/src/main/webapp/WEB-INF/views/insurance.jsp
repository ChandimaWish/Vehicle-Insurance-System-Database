					...
					<tbody>
						<tr>
							...
							<td> 
								...
								|
								<a href = "#" onclick="confirmDelete ('${contextRoot}/deleteInsurance.html?id=${insurance.id}')" data-toggle="tooltip" title="Delete"><span class="glyphicon glyphicon-trash" style = "font-size: 16px; color: black;"></span></a>
							</td>
						</tr>
					</tbody>
				</c:forEach>
