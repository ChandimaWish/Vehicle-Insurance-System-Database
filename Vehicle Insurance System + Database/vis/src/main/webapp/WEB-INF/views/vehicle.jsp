				...
				<c:forEach items="${list}" var="vehicle">
					...
					<tbody>
						<tr>
							...
							<a href = "#" onclick="confirmDelete('${contextRoot}/deleteVehicle.html?id=${vehicle.id}')" data-toggle="tooltip" title="Delete"><span class="glyphicon glyphicon-trash" style = "font-size: 16px; color: black;"></span></a>
							</td>
						</tr>
					</tbody>
				</c:forEach>
